...
// COMPONENT
// ──────────────────────────────────────────────────────────
export default function HomePage({ prices }: { prices: PriceConfig }) {
  ...
  > = {
    en: {
      dozen1: [
        { label: 'Large Size', weight: '3.3 kg to 3.6 kg', price: `₹${prices.dozen1.large.price}`, oldPrice: `₹${prices.dozen1.large.oldPrice}` },
        { label: 'Medium Size', weight: '2.7 kg to 3.0 kg', price: `₹${prices.dozen1.medium.price}`, oldPrice: `₹${prices.dozen1.medium.oldPrice}` },
      ],
      dozen2: [
        { label: 'Large Size', weight: '6.6 kg to 7.2 kg', price: `₹${prices.dozen2.large.price}`, oldPrice: `₹${prices.dozen2.large.oldPrice}` },
        { label: 'Medium Size', weight: '5.4 kg to 6.0 kg', price: `₹${prices.dozen2.medium.price}`, oldPrice: `₹${prices.dozen2.medium.oldPrice}` },
      ],
    },
    hi: {
      dozen1: [
        { label: 'लार्ज साइज', weight: '3.3 kg से 3.6 kg', price: `₹${prices.dozen1.large.price}`, oldPrice: `₹${prices.dozen1.large.oldPrice}` },
        { label: 'मीडियम साइज', weight: '2.7 kg से 3.0 kg', price: `₹${prices.dozen1.medium.price}`, oldPrice: `₹${prices.dozen1.medium.oldPrice}` },
      ],
      dozen2: [
        { label: 'लार्ज साइज', weight: '6.6 kg से 7.2 kg', price: `₹${prices.dozen2.large.price}`, oldPrice: `₹${prices.dozen2.large.oldPrice}` },
        { label: 'मीडियम साइज', weight: '5.4 kg से 6.0 kg', price: `₹${prices.dozen2.medium.price}`, oldPrice: `₹${prices.dozen2.medium.oldPrice}` },
      ],
    },
    mr: {
      dozen1: [
        { label: 'लार्ज साइज', weight: '3.3 kg ते 3.6 kg', price: `₹${prices.dozen1.large.price}`, oldPrice: `₹${prices.dozen1.large.oldPrice}` },
        { label: 'मिडियम साइज', weight: '2.7 kg ते 3.0 kg', price: `₹${prices.dozen1.medium.price}`, oldPrice: `₹${prices.dozen1.medium.oldPrice}` },
      ],
      dozen2: [
        { label: 'लार्ज साइज', weight: '6.6 kg ते 7.2 kg', price: `₹${prices.dozen2.large.price}`, oldPrice: `₹${prices.dozen2.large.oldPrice}` },
        { label: 'मिडियम साइज', weight: '5.4 kg ते 6.0 kg', price: `₹${prices.dozen2.medium.price}`, oldPrice: `₹${prices.dozen2.medium.oldPrice}` },
      ],
    },
  }
